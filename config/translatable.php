...
return [
    ...
    */
    'locales' => [
            'en','ps','sq','hy','pt','es-AR','de','nl','sv','az','bs','bn','fr','bg','ar',
            'ms','es-BO','dz','no','be','es-CL','zh-CN','es-CO','es-CR','es','el','cs','da',
            'es-DO','es-EC','et','ti','am','fi','fo','ka','kl','es-GT','es-HN','hr','hu','id',
            'ga','he','hi','fa','is','it','ja','ky','km','ko','kk','lo','si','lt','lv','ro',
            'sr','mk','my','mn','zh','mt','dv','es-MX','es-NI','ne','es-PA','es-PE','tl','pl',
            'es-PR','es-PY','ru','rw','sl','sk','so','es-SV','th','tg','tk','tr','sw','uk',
            'es-UY','uz','la','es-VE','vi','bi','sm','af'
    ],
